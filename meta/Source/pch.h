...
#define DISPLAYORDER_LowerThird		699
...
#define GAMEBROWSER_WIDTH (SCREEN_WIDTH - LIVESPLIT_WIDTH)
#define GAMEBROWSER_HEIGHT 1080
#define GAMEBROWSER_MARGINS HyMargins<int16_t>(100, 150, 100, 69)
...
#define MONITOR_HEIGHT_OFFSET_CRT 312
#define MONITOR_HEIGHT_OFFSET_CODE 563
...
#define LOWERTHIRD_HEIGHT 203//209
